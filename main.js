    ...
    $.fn.toggleSwitch = function () {
        return this.each(function () {
            ...
            const updateUI = () => {
                ...
                if (isChecked) {
                    // Se o botão estiver ativo (ligado), exiba a mensagem de aniversário
                    const birthdayMessage = '<div class="birthday-message">Feliz Aniversário Matheus!!!</div>';
                    $('body').append(birthdayMessage);
                } else {
                    // Caso contrário, remova a mensagem e o ícone
                    $('.birthday-message').remove();
                }
            };
